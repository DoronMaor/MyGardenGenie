...
#  Apr 05, 2023 10:02:45 AM +0300  platform: Windows NT
set vTcl(timestamp) ""
...
### SPOT dump_widget_opt A
    ...
    frame "$top.fra48" \
        ...
        -width 125 
    vTcl:DefineAlias "$top.fra48" "header_frame" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    ...
    vTcl:DefineAlias "$site_3_0.lab54" "status_label" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    place $site_3_0.lab54 \
        -in $site_3_0 -x 0 -relx 0.612 -y 0 -rely 0.182 -width 0 \
        -relwidth 0.381 -height 0 -relheight 0.745 -anchor nw \
        -bordermode ignore 
    ttk::style configure Frame -background $vTcl(actual_gui_bg)
    ttk::style configure Frame -foreground $vTcl(actual_gui_fg)
    ttk::style configure Frame -font "$vTcl(actual_gui_font_dft_desc)"
    frame "$top.fra49" \
        ...
        -highlightcolor black -width 850 
    vTcl:DefineAlias "$top.fra49" "plants_frame" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    ...
    label "$site_3_0.lab52" \
        ...
        -font "-family Calibri -size 14 -weight normal -slant roman -underline 0 -overstrike 0" \
        -foreground $vTcl(actual_gui_fg) -text "Plant A" 
...
### SPOT dump_widget_opt A
    ...
    label "$site_3_0.lab53" \
        ...
        -text "Plant B" 
    vTcl:DefineAlias "$site_3_0.lab53" "Label1_1" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    place $site_3_0.lab52 \
        -in $site_3_0 -x 0 -relx 0.012 -y 0 -rely 0.182 -width 0 \
        -relwidth 0.475 -height 0 -relheight 0.745 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab53 \
        -in $site_3_0 -x 0 -relx 0.506 -y 0 -rely 0.182 -width 0 \
        -relwidth 0.474 -height 0 -relheight 0.745 -anchor nw \
        -bordermode ignore 
...
### SPOT dump_widget_opt A
    ...
    vTcl:DefineAlias "$top.tex56" "Text1_1" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    ttk::style configure TSeparator -background $vTcl(actual_gui_bg)
    ttk::style configure TSeparator -foreground $vTcl(actual_gui_fg)
    ttk::style configure TSeparator -font "$vTcl(actual_gui_font_dft_desc)"
...
### SPOT dump_widget_opt A
    ...
    button "$top.but61" \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text "Button" 
    vTcl:DefineAlias "$top.but61" "Button1_1" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    ttk::style configure Button -background $vTcl(actual_gui_bg)
    ttk::style configure Button -foreground $vTcl(actual_gui_fg)
    ttk::style configure Button -font "$vTcl(actual_gui_font_dft_desc)"
    button "$top.but62" \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text "Button" 
    vTcl:DefineAlias "$top.but62" "Button1_1_1" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    ###################
    # SETTING GEOMETRY
    ###################
    ...
    place $top.tex56 \
        -in $top -x 0 -relx 0.518 -y 0 -rely 0.218 -width 0 -relwidth 0.474 \
        -height 0 -relheight 0.571 -anchor nw -bordermode ignore 
    place $top.tSe57 \
        -in $top -x 0 -relx 0.012 -y 0 -rely 0.836 -width 0 -relwidth 0.966 \
        -height 0 -relheight 0.004 -anchor nw -bordermode ignore 
    place $top.but60 \
        -in $top -x 0 -relx 0.009 -y 0 -rely 0.855 -width 276 -relwidth 0 \
        -height 74 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but61 \
        -in $top -x 0 -relx 0.339 -y 0 -rely 0.855 -width 276 -relwidth 0 \
        -height 74 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but62 \
        -in $top -x 0 -relx 0.668 -y 0 -rely 0.855 -width 276 -relwidth 0 \
        -height 74 -relheight 0 -anchor nw -bordermode ignore 
