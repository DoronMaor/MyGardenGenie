...
class HomePage:
    def __init__(self, garden_management, top=None):
        ...
        self.menubar.add_command(compound='left', label='Test Routine', command=lambda: self.test_routine_action(garden_management))
    ...
    def test_routine_action(self, garden_management):
        # Perform the desired action here
        garden_management.turn_blitz_mode()
